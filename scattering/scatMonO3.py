...
if plotspec==1:
	...
	# load timeseries for witness channel
        witness=TimeSeries.fetch(witness_chan, start_time, start_time+dur,allow_tape=False)
...
'SUS-ZM1_M1_DAMP_L_IN1_DQ',\
'SUS-ZM2_M1_DAMP_L_IN1_DQ',\
]
...
for channel in position_chans:
	...
	#fudge = 1.0
	scatf1 = abs(2.0*velocity.value/1.064) # single bounce scatter frequency Virgo Scatter eqn 3
	scatf2 = 2.0*scatf1
	scatf3 = 20.0*scatf1
	scatf4 = 100.0*scatf1
	#scatf5 = 40.0*scatf1
